    ...
    <div class="row">
      <div class="col-12 col-md-6">
        <div class="promo-text">
          <h1 class="headtext">Финансовые решения и технологии для бизнеса</h1>
          <h3 class="headsubtext">
              Наводим порядок в счетах и документах, пишем полезные программы, обучаем финансовой грамотности
          </h3>
        </div>
      </div>
      <!-- /col -->
